...
class DataFramesCollector:
    ...
    def load_dataframe_from_csv(csv_file):
        ...
        if df.shape[0] == 0:
            print('Gaze frame is empty: some kind of problem with this participant or file. Ignoring data set: ',
                  csv_file)
            return None
    ...
    @staticmethod
    def load_gazeframes(path_of_directory):
        return DataFramesCollector.get_gaze_data_frames(path_of_directory)
